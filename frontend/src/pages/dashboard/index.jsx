                                    ...
                                    return (
                                        <div key={post._id} className={styles.singleCard}>
                                            ...
                                            <div className={styles.singleCardProfileContainer}>
                                                <img className={styles.userProfile} src={`${BASE_URL}/${post.userId.profilePicture}`} alt="User" />
                                                <div>
                                                    ...
                                                    <div className={styles.optionsContainer}>
                                                        ...
                                                        <div onClick={() => {
                                                            ...
                                                            const twitterUrl = `https://twitter.com/intent/tweet?text=${text}&urk=${url}`;
                                            ...
                                            return (
                                                <div className={styles.singleComment} key={comment._id}>
                                                    <div className={styles.singleComment__profileContainer}>
                                                        <img width={50} src={`${BASE_URL}/${comment.userId.profilePicture}`} alt="" />
                                                        <div>
